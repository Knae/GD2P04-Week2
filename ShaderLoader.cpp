...
/// <summary>
/// Create shader using openGL functions.
/// Assuming shaderName refers to filename
/// </summary>
...
GLuint ShaderLoader::CreateShader(GLenum shaderType, const char* shaderName)
{
	...
	std::string sourceString = ReadShaderFile(shaderName);
	const char* source = &sourceString[0];
