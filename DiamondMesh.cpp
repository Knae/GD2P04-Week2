...
CDiamondMesh* CDiamondMesh::m_pThisShape = nullptr;

/// <summary>
/// Initial setup of the diamond mesh
/// </summary>
/// <returns></returns>
bool CDiamondMesh::SetupShape()
{
	try
	{
		//Generate VAO
		...
		std::cout << "Diamond mesh built\n";
		return true;
	}
	catch (const std::exception&)
	{
		std::cout << "Failed to setup Diamond mesh. VAO ID: " << m_iID_VAO << "\n";
		return false;
	}
}
/// <summary>
...
bool CDiamondMesh::Draw()
{
	...
	{
		std::cout << "Failed to draw Diamond mesh VAO ID: " << m_iID_VAO << "\n";
		return false;
	}
}

CDiamondMesh::CDiamondMesh()
{
}
